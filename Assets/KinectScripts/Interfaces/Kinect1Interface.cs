...
public class Kinect1Interface : DepthSensorInterface 
{
	...
	public bool InitSensorInterface (ref bool bNeedRestart)
	{
		...
		else
		{
			...
			KinectInterop.CopyResourceFile("KinectUnityWrapper.dll", "KinectUnityWrapper.dll.x64", ref bOneCopied, ref bAllCopied);
			KinectInterop.CopyResourceFile("KinectInteraction180_64.dll", "KinectInteraction180_64.dll.x64", ref bOneCopied, ref bAllCopied);
			KinectInterop.CopyResourceFile("FaceTrackData.dll", "FaceTrackData.dll", ref bOneCopied, ref bAllCopied); // use the same data-dll
			KinectInterop.CopyResourceFile("FaceTrackLib.dll", "FaceTrackLib.dll.x64", ref bOneCopied, ref bAllCopied);
			KinectInterop.CopyResourceFile("KinectBackgroundRemoval180_64.dll", "KinectBackgroundRemoval180_64.dll.x64", ref bOneCopied, ref bAllCopied);
			
			KinectInterop.CopyResourceFile("msvcp100d.dll", "msvcp100d.dll.x64", ref bOneCopied, ref bAllCopied);
			KinectInterop.CopyResourceFile("msvcr100d.dll", "msvcr100d.dll.x64", ref bOneCopied, ref bAllCopied);
		}
