...
using MongoDB.Bson.Serialization.Attributes;
    ...
    public class DatabasePDetails
    {
        ...
        public void EditAllDetails(PatientDetails details)
        {
            ...
            patientdetails.Collection.Update(
                ...
                Update.Set("Name", details.Name)
                    ...
                    .Set("WorkoutLevel", details.WorkoutLevel)
        ...
        public IList<PatientWorkout> GetAllWorkouts(string username)
        {
            if (CheckUserName(username))
            {
                var details = patientdetails.Collection.Find(Query.EQ("PUserName", username)).SetFields(Fields.Exclude("PUserName", "Name", "Email", "Address", "DateOfBirth", "PhoneNumber", "WorkoutLevel", "Condition", "Diagnosis", "Messages")).Single();
        ...
        public IList<PatientDiagnosis> GetAllDiagnosis(string username)
        {
            if (CheckUserName(username))
            {
                var details = patientdetails.Collection.Find(Query.EQ("PUserName", username)).SetFields(Fields.Exclude("PUserName", "Name", "Email", "Address", "DateOfBirth", "PhoneNumber", "WorkoutLevel", "Condition", "Workouts", "Messages")).Single();
        ...
        public IList<PatientMessages> GetAllMessages(string username)
        {
            if (CheckUserName(username))
            {
                var details = patientdetails.Collection.Find(Query.EQ("PUserName", username)).SetFields(Fields.Exclude("PUserName", "Name", "Email", "Address", "DateOfBirth", "PhoneNumber", "WorkoutLevel", "Condition", "Workouts", "Diagnosis")).Single();
        ...
        public void EditWorkoutLevel(string username, int workoutLevel)
        {
            if (CheckUserName(username))
            {
                patientdetails.Collection.Update(Query.EQ("PUserName", username),
                    Update.Set("WorkoutLevel", workoutLevel));
            }
